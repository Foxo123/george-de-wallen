        ...
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="d-block w-100" src="./img/about-us-carousel/food1.jpg" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="./img/about-us-carousel/food2.jpg" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="./img/about-us-carousel/food3.jpg" alt="Third slide">
            </div>
          </div>
