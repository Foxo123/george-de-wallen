...
<html lang="en">
  ...
  <div class="row">
    <div class="col">
    <center><a href="./studentcalenderchange.php" type= "button" class="btn btn-primary btn-lg btn-block"> setting up a new working date.</a> </center>
    <table class="table table-hover">
    <thead>
      <tr>
        <th scope="col" class="">Weeknumber</th>
